...
Instuctions on how to build and run on Linux
...
2. open cmd and go to the directory where you cloned the repositoy
3. Run ant
4. cd dist
...
1. verifier -compat 
	outputs a space seperated list of all versions of Verificatum for which the verifier is compatible
...
If the "-v" option is chosen, the verifier will print logging messeges during the verification process.