...
/**
 * Tests for class ModGroupElement class.
 * @author Itay
 *
 */
public class ModGroupElementTest {
	...
	public void toByteArrayTest() {
		...
		Assert.assertEquals(Arrays.toString(b),
				Arrays.toString(a.toByteArray()));

		byte[] b2 = { 1, 0, 0, 0, 2, 0, 13 };
		Assert.assertEquals(Arrays.toString(b2),
				Arrays.toString(c.toByteArray()));
	}
	...
	public void equalTest() {
		Assert.assertTrue(a.equals(new ModGroupElement(new LargeInteger("1"),
				group1)));
		Assert.assertTrue(a.equals(new ModGroupElement(new LargeInteger("264"),
				group1)));
	}
	...
	public void powerTest() {
		Assert.assertTrue(e.power(new LargeInteger("3")).equals(
				new ModGroupElement(e.getElement().modPow(
						new LargeInteger("3"), e.getGroup().getFieldOrder()),
						group1)));
	}
